  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-zinc-700 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
          ...
          <div className="flex items-center justify-between p-4 border-b border-zinc-800">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="text-xs text-brand-soft hover:text-white"
              >
                Mark all read
              </button>
            )}
