  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-accent-2 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
      ...
      {open && (
        <div className="absolute left-0 max-md:left-auto max-md:right-0 mt-2 w-80 max-w-[calc(100vw-2rem)] bg-zinc-900 border border-zinc-800 rounded-xl shadow-xl z-50 max-h-96 overflow-y-auto scrollbar-dark">
