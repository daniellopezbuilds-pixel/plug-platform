 ...
 * The strip scrolls sideways instead, bleeding to the screen edge below md
 * (`-mx-4 px-4`) so a half-visible tab at the right edge shows there is more
...
export function Tabs<K extends string>({
  ...
  return (
    <div
      ...
      className={`flex gap-2 border-b border-zinc-800 overflow-x-auto scrollbar-dark -mx-4 px-4 md:mx-0 md:px-0 ${className}`}
    >
      {tabs.map((tab) => {
