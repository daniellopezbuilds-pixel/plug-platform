    ...
    <div className="space-y-1">
      {conversations.map((conv) => (
        ...
        >
          ...
          >
            {conv.isUnread && (
              <span className="w-2 h-2 rounded-full bg-accent-2 mt-2 flex-shrink-0" />
            )}
          ...
          <button
            ...
            className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition text-xs text-gray-400 hover:text-rose-400"
