...
| Production | **Fourteen migrations applied**, through `20260918120000`. The fourteen CSLB, badge, realtime, jobs, application-loop and resume-access files have not been pushed here |
| Staging | **Fully up to date** — everything through `20260922200000` applied |
